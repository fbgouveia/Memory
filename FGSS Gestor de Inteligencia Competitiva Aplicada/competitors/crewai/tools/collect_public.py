#!/usr/bin/env python3
"""Coleta determinística das superfícies públicas do crewai.com."""
...
def same_origin(url: str) -> bool:
    ...
    return host == "crewai.com" or host == "www.crewai.com" or host.endswith(".crewai.com")
...
def collect(root: Path) -> int:
    if root.name != "crewai" or not (root / "CONTRACT.md").is_file():
