...
- Source: https://docs-platform.crewai.com/platform/en/integrations/google_contacts
- Raw SHA-256: `30ac6e012fdfce46f941a556ab772fa1f57c8692418409f4ea7907bfe449e7a2`
...
crewAIInc/crewAI
Search...
Navigation Integration Docs Google Contacts Integration
Getting Started
CrewAI AMP
Build
Automations
...
names (array, optional): Person’s names [ { "givenName" : "John" , "familyName" : "Doe" , "displayName" : "John Doe" } ]
emailAddresses (array, optional): Email addresses [ { "value" : "john.doe@example.com" , "type" : "work" } ]
phoneNumbers (array, optional): Phone numbers [ { "value" : "+1234567890" , "type" : "mobile" } ]
addresses (array, optional): Postal addresses [ { "formattedValue" : "123 Main St, City, State 12345" , "type" : "home" } ]
organizations (array, optional): Organizations/companies [ { "name" : "Company Name" , "title" : "Job Title" , "type" : "work" } ]
...
clientData (array, optional): Client-specific data [ { "key" : "data_key" , "value" : "data_value" } ]
