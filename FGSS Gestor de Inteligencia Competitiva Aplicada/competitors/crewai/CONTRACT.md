# Contrato de absorção — CrewAI

## Visão

Tratar o CrewAI como concorrente e referência estratégica do FGSS.io,
...
1. Site público: `https://crewai.com/` (homepage declarada no GitHub).
2. Rotas públicas descobertas no site, incluindo docs, pricing e enterprise.
3. Repositório público declarado open source pelo próprio site:
   `https://github.com/crewAIInc/crewAI`.
4. Links externos são inventariados, mas não atravessados automaticamente.
